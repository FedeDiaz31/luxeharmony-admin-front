                    ...
                    <div className="w-full fade-in">
                      ...
                      <div className="flex ">
                        <img
                          ...
                          alt="logo"
                        />
                        <h4 className="font-semibold ml-[10vh]">
                          {brand.name}
                        </h4>
                      </div>
                      <div className="mt-5">
                      ...
                      <div className="flex mt-10">
                        ...
                        <button className="bg-bgSecondaryColor text-textPrimary px-8 rounded transition-all duration-200 hover:bg-bgPrimaryColor hover:text-textSecondary">
                          Delete
                        </button>
                      </div>
                    </div>
